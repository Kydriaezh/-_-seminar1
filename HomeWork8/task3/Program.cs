...
Console.Write("Введите количество рядов 1: ");
int row_1 = int.Parse(Console.ReadLine());
Console.Write("Введите количество колонок 1: ");
int column_1 = int.Parse(Console.ReadLine());

Console.Write("Введите количество рядов 2: ");
int row_2 = int.Parse(Console.ReadLine());
Console.Write("Введите количество колонок 2: ");
